	...
	<div class="span3">
		<div class="newsMenu">
			<ul class="nav nav-tabs nav-stacked">
				  ...
				  <li><a href="news?action=preSave">&nbsp;&nbsp;新闻添加</a></li>
				  <li><a href="news?action=backList">&nbsp;&nbsp;新闻维护</a></li>
				  <li><a href=""><strong>新闻评论管理</strong></a></li>
				  <li><a href="comment?action=backList">&nbsp;&nbsp;新闻评论维护</a></li>
				  <li><a href=""><strong>新闻类别管理</strong></a></li>
				  <li><a href="newsType?action=preSave">&nbsp;&nbsp;新闻类别添加</a></li>
				  <li><a href="newsType?action=backList">&nbsp;&nbsp;新闻类别维护</a></li>
				  <li><a href=""><strong>友情连接管理</strong></a></li>
				  <li><a href="link?action=preSave">&nbsp;&nbsp;友情连接添加</a></li>
				  <li><a href="link?action=backList">&nbsp;&nbsp;友情连接维护</a></li>
